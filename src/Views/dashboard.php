...
<head>
    ...
    <title>Dashboard - <?= htmlspecialchars($app_name ?? 'WebFTP', ENT_QUOTES, 'UTF-8') ?></title>
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <h1 class="text-2xl font-bold text-white"><?= htmlspecialchars($app_name ?? 'WebFTP', ENT_QUOTES, 'UTF-8') ?></h1>
                    <div class="hidden md:flex items-center space-x-2 text-sm">
                        <span class="px-3 py-1 bg-slate-700 text-slate-300 rounded-full">
                            <span class="text-slate-400">Host:</span>
                            <span class="font-medium text-white"><?= htmlspecialchars($ftp_host ?? 'N/A', ENT_QUOTES, 'UTF-8') ?></span>
                        </span>
                        <span class="px-3 py-1 bg-slate-700 text-slate-300 rounded-full">
                            <span class="text-slate-400">User:</span>
                            <span class="font-medium text-white"><?= htmlspecialchars($ftp_username ?? 'N/A', ENT_QUOTES, 'UTF-8') ?></span>
                        </span>
                    </div>
                </div>
                <div>
                    <a href="/logout" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition duration-200">
    ...
    <main class="container mx-auto px-6 py-8">
            ...
            <div class="bg-slate-900/50 rounded-lg p-6 max-w-2xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
                    <div class="bg-slate-800 rounded-lg p-4">
                        ...
                        <p class="text-white font-mono"><?= htmlspecialchars($ftp_host ?? 'N/A', ENT_QUOTES, 'UTF-8') ?></p>
                    </div>
                    <div class="bg-slate-800 rounded-lg p-4">
                        <p class="text-sm text-slate-400 mb-1">Username</p>
                        <p class="text-white font-mono"><?= htmlspecialchars($ftp_username ?? 'N/A', ENT_QUOTES, 'UTF-8') ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-blue-200 text-sm">
                                This is the first phase of the WebFTP client. The login system is fully functional with enterprise-grade security.
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-slate-800 rounded-lg p-6 border border-slate-700">
                ...
                <p class="text-slate-400 text-sm">All forms use cryptographically secure tokens to prevent cross-site request forgery attacks.</p>
            </div>
            ...
            <div class="bg-slate-800 rounded-lg p-6 border border-slate-700">
                ...
                <p class="text-slate-400 text-sm">Advanced session management with fingerprinting, regeneration, and hijacking prevention.</p>
            </div>
            ...
            <div class="bg-slate-800 rounded-lg p-6 border border-slate-700">
                ...
                <p class="text-slate-400 text-sm">Brute force protection with intelligent rate limiting and temporary account lockouts.</p>
            </div>
        </div>
