...
(function () {
    ...
    return originalFetch
      ...
      .then(async (response) => {
        ...
        if (response.status === 401) {
          ...
          console.warn(
            "401 Unauthorized - Session expired. Redirecting to login..."
          );
          ...
          if (contentType && contentType.includes("application/json")) {
            ...
            try {
              ...
              if (data.success === false) {
                ...
                if (window.showToast) {
                  window.showToast.error(errorTitle, errorMessage, {
                    duration: 5000,
                  });
                }
              }
  ...
  console.log(
    "API Interceptor loaded - All fetch calls monitored with toast notifications"
  );
})();
